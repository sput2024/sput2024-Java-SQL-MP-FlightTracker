...
public class FlightDAO {
    ...
    public List<Flight> getAllFlights(){
        ...
        try {
            ...
            String sql = "SELECT * FROM flight"; // "change me";
    ...
    public Flight getFlightById(int id){
        ...
        try {
            //Write SQL logic here
            String sql = "select * from flight where flight_id = ? "; //"change me";
    ...
    public Flight insertFlight(Flight flight){
        ...
        try {
            ...
            String sql = "INSERT INTO flight(departure_city,arrival_city) VALUES(?,?);"; //"change me" ;
            PreparedStatement preparedStatement = connection.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS);
            String dCity = flight.getDeparture_city();         //added 10/6/2024
            String aCity = flight.getArrival_city();
    ...
    public void updateFlight(int id, Flight flight){
        ...
        try {
            //Write SQL logic here
            String sql = "UPDATE flight set departure_city=?, arrival_city=? where flight_id = ?;";//"change me";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city){
        ...
        try {
            //Write SQL logic here
            String sql = "select * from flight where departure_city = ? and arrival_city = ?;";//"change me";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
